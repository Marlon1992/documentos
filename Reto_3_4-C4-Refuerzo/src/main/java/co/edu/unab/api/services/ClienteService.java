...
public class ClienteService {
    ...
    public ArrayList<ClienteModel>obtenerPorPuntos(Long puntos){
    ...
    public ArrayList<ClienteModel>obtenerPorPuntosmenor(Long puntos){
        return clienteRepository.findByPuntosLessThanEqual (puntos);
    }

    public ArrayList <ClienteModel> obtenerDosParametros(String nombre, String apellido){
        return clienteRepository.consultaDosParametros(nombre,apellido);
    }
